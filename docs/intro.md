...
|:--------------------------------------:|:---------------------------------:|:-------------:|:------------------------------------------------------------------------------------------:|
| Capitais, Cidades e Vilas              | llp_localidade                    | Ponto         | Conforme regras para Carta Topográfica                                                                                          |
...
| Ferrovias                              | infra_ferrovia                    | Linha         | Todas as Ferrovias                                                                                          |
| Lagos, represas, baías, oceano         | cobter_massa_dagua                | Área          | Somente elementos com nome                                                                 |
| Rios e Canais representáveis em escala | cobter_massa_dagua                | Área          | Somente elementos com nome, e este distinto do nome do trecho de drenagem                                                                 |
...
|            				Elemento 			           |      				Classe 				conforme EDGV 3.0 Orto 			     |       				Geometria 			      |                                        				Descrição 			                                       |
|:------------------------------:|:---------------------------------------:|:---------------------:|:---------------------------------------------------------------------------------------:|
|  				Curvas 				de Nível 			              |  				elemnat_curva_nivel 			                   |  				Linha 			               |  				Mesma equidistância prevista para Carta Topográfica 			                                                                                     |
|  				Pontos 				cotados 			               |  				elemnat_ponto_cotado 			                  |  				Ponto 			               |  				Pontos cotados conforme regras para Carta Topográfica 			                                                                                     |
|  				Aglomerados 				rurais 			           |  				llp_aglomerado_rural 			                  |  				Ponto 			               |  				Conforme regras para Carta Topográfica 			                                                                                     |
|  				Nomes 				locais 			                 |  				llp_nome_local 			                        |  				Ponto 			               |  				Conforme regras para Carta Topográfica 			                                                                                     |
...
|  				Pistas 				de Pouso e Helipontos 			 |  				infra_pista_pouso 			                     |  				Ponto, 				Linha e Área 			 |  				Indicar no centro da pista de pouso 			                                                                                     |
|  				Atracadouro/Terminal 			         |  				infra_elemento_infraestrutura 			         |  				Ponto, 				Linha e Área 			 |  				Indicar com um único ponto 			                                                                                     |
|  				Subestação 				de Energia 			        |  				infra_elemento_energia 			                |  				Ponto 				e Área 			        |  				Indicar com ponto ou área conforme regras para Carta Topográfica 			                                                                                     |
|  				Trecho 				de energia 			            |  				infra_elemento_energia 			                |  				Linha 			               |  				Somente 				linhas de transmissão 			                                              |
|  				Corredeiras 				e queda d’água 			   |  				elemnat_elemento_hidrografico 			         |  				Ponto 			               |  				Somente 				com nome 			                                                                      |
|  				Terreno 				sujeito inundação 			    |  				elemnat_terreno_sujeito_inundacao 			     |  				Área 			                |  				Conforme regras para Carta Topográfica 			                                                                                     |
|  				Extração 				mineral 			             |  				constr_extracao_mineral 			               |  				Ponto 				ou Área 			       |  				Indicar com ponto ou área conforme regras para Carta Topográfica 			                                                                                     |
